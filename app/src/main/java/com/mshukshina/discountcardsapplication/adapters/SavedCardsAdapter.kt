...
import com.mshukshina.discountcardsapplication.databinding.CardItemBinding
import com.mshukshina.discountcardsapplication.fragmentsandactivities.MainActivity
...
class SavedCardsAdapter(private val activity: MainActivity) :
    ...
    override fun onBindViewHolder(holder: SavedCardsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickHandler(card)
        }
        holder.favoriteIcon.setOnClickListener {
            onFavIconClickHandler(card)
